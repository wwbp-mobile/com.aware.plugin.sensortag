...
public class Provider extends ContentProvider {
    ...
    public static String AUTHORITY = "com.aware.plugin.sensortag.provider.sensortag"; //change to package.provider.your_plugin_name
    ...
    public static final String DATABASE_NAME = Environment.getExternalStorageDirectory() + "/AWARE/plugin_sensortag.db"; //the database filename, use plugin_xxx for plugins.

    //Add here your database table names, as many as you need
    public static final String DB_SENSOR_DATA = "sensor_data";
     ...
     */
    public static final class Sensor_Data implements AWAREColumns {
        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + DB_SENSOR_DATA);
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.aware.plugin.template.provider.sensor_data"; //modify me
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.aware.plugin.template.provider.sensor_data"; //modify me
    ...
    private static final String DB_TBL_SENSOR_DATA_FIELDS =
    ...
    private HashMap<String, String> sensorDataHash;
    ...
    public boolean onCreate() {
        ...
        // TODO this might throw an error, come back here if data doesn't get uploaded
        AUTHORITY = getContext().getPackageName() + ".provider.sensortag"; //make sure xxx matches the first string in this class
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TABLE_ONE_DIR:
                long _id = database.insert(DATABASE_TABLES[0], Sensor_Data.DEVICE_ID, values);
                database.setTransactionSuccessful();
                database.endTransaction();
                if (_id > 0) {
                    Uri dataUri = ContentUris.withAppendedId(Sensor_Data.CONTENT_URI, _id);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case TABLE_ONE_DIR:
                ...
                qb.setProjectionMap(sensorDataHash); //the hashmap of the table
                break;
